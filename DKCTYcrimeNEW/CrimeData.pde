    ...
    try
    {
      ...
      while (scan.hasNext()) {
        ...
        if (data[0].equals("2018") && data[1].equals("A")) {
          ...
          firstAdult.put("Lakeville", Integer.parseInt(data[7]));
          firstAdult.put("TheRest", Integer.parseInt(data[8]));
        }
        if (data[0].equals("2018") && data[1].equals("J")) {
          ...
          firstJuvenile.put("Lakeville", Integer.parseInt(data[7]));
          firstJuvenile.put("TheRest", Integer.parseInt(data[8]));
        }
        if (data[0].equals("2017") && data[1].equals("A")) {
          ...
          secondAdult.put("Lakeville", Integer.parseInt(data[7]));
          secondAdult.put("TheRest", Integer.parseInt(data[8]));
        }
        if (data[0].equals("2017") && data[1].equals("J")) {
          ...
          secondJuvenile.put("Lakeville", Integer.parseInt(data[7]));
          secondJuvenile.put("TheRest", Integer.parseInt(data[8]));
        }
        if (data[0].equals("2016") && data[1].equals("A")) {
          ...
          thirdAdult.put("Lakeville", Integer.parseInt(data[7]));
          thirdAdult.put("TheRest", Integer.parseInt(data[8]));
        }
        if (data[0].equals("2016") && data[1].equals("J")) {
          ...
          thirdJuvenile.put("Lakeville", Integer.parseInt(data[7]));
          thirdJuvenile.put("TheRest", Integer.parseInt(data[8]));
        }
        if (data[0].equals("2015") && data[1].equals("A")) {
          ...
          fourthAdult.put("Lakeville", Integer.parseInt(data[7]));
          fourthAdult.put("TheRest", Integer.parseInt(data[8]));
        }
        if (data[0].equals("2015") && data[1].equals("J")) {
          ...
          fourthJuvenile.put("Lakeville", Integer.parseInt(data[7]));
          fourthJuvenile.put("TheRest", Integer.parseInt(data[8]));
        }
        if (data[0].equals("2014") && data[1].equals("A")) {
          ...
          fifthAdult.put("Lakeville", Integer.parseInt(data[7]));
          fifthAdult.put("TheRest", Integer.parseInt(data[8]));
        }
        if (data[0].equals("2014") && data[1].equals("J")) {
          ...
          fifthJuvenile.put("Lakeville", Integer.parseInt(data[7]));
          fifthJuvenile.put("TheRest", Integer.parseInt(data[8]));
        }
